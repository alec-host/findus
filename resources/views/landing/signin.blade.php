                        ...
                        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <div>
                                <form action="/sign-in" method="POST">
                                    ...
                                    <div class="flex -mx-3">
                                        <div class="w-full px-3 mb-5">
                                            ...
                                            <div class="flex">
                                                ...
                                                <input name="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-green-500" placeholder="admin@company.com" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex -mx-3">
                                        <div class="w-full px-3 mb-5">
                                            <button class="block w-full max-w-xs mx-auto bg-green-500 hover:bg-green-700 focus:bg-green-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">LOGIN NOW</button>
                                        </div>
                                    </div>
                                </form>
                                <p class="flex justify-between inline-block mt-4 text-xs text-gray-500 cursor-pointer hover:text-black">
                                    <a href="/subscribe">
                                        Not registered? Click here register now
                                    </a>
                                </p>
                                <p class="flex justify-between inline-block mt-4 text-xs text-gray-500 cursor-pointer hover:text-black">
