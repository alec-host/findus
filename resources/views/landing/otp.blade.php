                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900">OTP Authentication</h1>
                            <p>
                                Enter the OTP code sent to your company email
                            </p>
                        </div>
                        <div>
                            <form action="/authenticate-client" method="POST">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-xs font-semibold px-1">OTP Code<span class="text-[#ff0000]">*</span></label>
                                        <div class="flex">
                                            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input type="number" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-green-500" placeholder="000111" name="otp_code" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <button type="submit" class="block w-full max-w-xs mx-auto bg-green-500 hover:bg-green-700 focus:bg-green-700 text-white rounded-lg px-3 py-3 font-semibold">VERIFY OTP</button>
                                    </div>
                                </div>
                            </form>
                        </div>
