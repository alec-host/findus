...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h1 class="m-0">'{{$company_name}}' Items List</h1>
                </div><!-- /.col -->
                <div class="col-sm-4">
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Items List between {{$start_date}} & {{$end_date}}</h3>
                        ...
                        <div class="card-body">
                            <div >
                                <div class="bootstrap-iso">
                                    <form method="post" action="/filter-items-list">
                                        @csrf
                                        @if ($errors->any())
                            ...
                            <iframe src="/items-list-pdf-filtered/{{$start_date}}/{{$end_date}}" style="height: 1000px; width: 100%;">Your browser isn't compatible</iframe>
                        </div>
                        <!-- /.card-body -->
