...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h1 class="m-0">'{{$company_name}}' GRN Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-4">
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">GRN Report between {{$start_date}} & {{$end_date}}</h3>
                        ...
                        <div class="card-body">
                            {{-- <div class="row"> --}}
                                <div >
                                    <div class="bootstrap-iso">
                                        <form method="post" action="/filter-grn-report">
                                            @csrf
                                            @if ($errors->any())
                            ...
                            <iframe src="/grn-report-pdf-filtered/{{$start_date}}/{{$end_date}}" style="height: 1000px; width: 100%;">Your browser isn't compatible</iframe>
                        </div>
                        <!-- /.card-body -->
