        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-12">
                    <form action="/register-receiving"  method="POST">
                        @csrf
                        <div class="card" >
                        <!-- /.box-header -->
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12 pull pull-left">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="receiving_date_time" data-target-input="nearest">
                                                <input type="text" class="form-control datetimepicker-input" name="receiving_date_time" data-target="#receiving_date_time" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" name="receiving_notes" autocomplete="off"></textarea>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-xs-12 pull pull-left">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="total_paid_amount " value="0" autocomplete="off" required>
                                    ...
                                    <div class="col-12 col-xs-12 pull pull-left">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txn_ref " value="" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-12 col-xs-12 pull pull-left">
                                        <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> Register Receiving</button>
